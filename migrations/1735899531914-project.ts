...
export class Project1735899531914 implements MigrationInterface {
    name = 'Project1735899531914'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`BaseModel\` (\`id\` varchar(36) NOT NULL, \`auditCreatedDateTime\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`auditCreatedBy\` varchar(50) NOT NULL, \`auditModifiedDateTime\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`auditModifiedBy\` varchar(50) NULL, \`auditDeletedDateTime\` datetime(6) NULL, \`auditDeletedBy\` varchar(50) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`payment\` (\`id\` varchar(36) NOT NULL, \`auditCreatedDateTime\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`auditCreatedBy\` varchar(50) NOT NULL, \`auditModifiedDateTime\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`auditModifiedBy\` varchar(50) NULL, \`auditDeletedDateTime\` datetime(6) NULL, \`auditDeletedBy\` varchar(50) NULL, \`loanId\` varchar(255) NOT NULL, \`paymentAmount\` float NOT NULL DEFAULT '0', \`paymentDate\` varchar(100) NOT NULL, \`paymentMethod\` varchar(100) NOT NULL, \`paymentStatus\` varchar(100) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`payment\` DROP FOREIGN KEY \`FK_47d8439ec0f7527bf93454c1194\``);
